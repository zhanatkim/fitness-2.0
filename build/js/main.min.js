...
},{"./modules/form-validate/form":4,"./modules/init-tabs":10,"./modules/modals/init-modals":11,"./modules/tariff-cards":14,"./modules/video-player":15,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.tariffForHalfYear = exports.tariffForFullYear = exports.tariff = void 0;
...
var tariffForHalfYear = [].concat(tariff).map(function (el) {
  return _objectSpread(_objectSpread({}, el), {}, {
    price: el.price * 6 * 0.9
  });
});
exports.tariffForHalfYear = tariffForHalfYear;
var tariffForFullYear = [].concat(tariff).map(function (el) {
  return _objectSpread(_objectSpread({}, el), {}, {
    price: el.price * 12 * 0.8
  });
});
...
//   return item;
// });
exports.tariffForFullYear = tariffForFullYear;
...
var renderMembership = function renderMembership() {
  ...
  createCardsList(_mocks.tariff);
  createCardsList(_mocks.tariffForHalfYear);
  createCardsList(_mocks.tariffForFullYear);
};
exports.renderMembership = renderMembership;

},{"../mocks":2}],15:[function(require,module,exports){
"use strict";
