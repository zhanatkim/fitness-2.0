...
},{"./modules/accordions/init-accordion":3,"./modules/faq":4,"./modules/form-validate/form":6,"./modules/modals/init-modals":12,"./modules/tabs/init-tabs":14,"./modules/tariff-cards":16,"./modules/video-player":17,"./utils/ios-vh-fix":20}],2:[function(require,module,exports){
"use strict";
...
function showChapter(evt) {
  ...
  var controlId = evt.target.dataset.id;
  var currentChapter = chaptersContainer.querySelector("[data-id='".concat(controlId, "']"));
